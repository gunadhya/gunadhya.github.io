...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f924da1d16686a50c63ba76d7fdfe104d75d947fb242aff9c95c5a8ba737a6d3.js',function(){input.required=false;search();});}
